...
namespace CMPG223_Project
{
    public partial class MakeAdvert : Form
    {
        ...
        public string insert , constr = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\tinus\Desktop\CMPG223(v2)\CMPG223_Project\Textbooks.mdf;Integrated Security = True";
        ...
        private void MakeAdvert_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                string constr = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\tinus\Desktop\CMPG223(v2)\CMPG223_Project\Textbooks.mdf;Integrated Security = True";
                conn = new SqlConnection(constr);
                conn.Open();
                conn.Close();
            }
