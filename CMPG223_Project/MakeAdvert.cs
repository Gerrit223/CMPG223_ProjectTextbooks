...
namespace CMPG223_Project
{
    public partial class MakeAdvert : Form
    {
        ...
        public string insert , constr = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=E:\CMPG 223 Project\CMPG223_Project\Textbooks.mdf;Integrated Security = True";
        ...
        public int getPrimaryKeyValue(string sql)
        {
            ...
            int primarykey;
            using (conn = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=E:\CMPG 223 Project\CMPG223_Project\Textbooks.mdf;Integrated Security = True"))
            {
                conn.Open();
        ...
        private void MakeAdvert_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                string constr = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=E:\CMPG 223 Project\CMPG223_Project\Textbooks.mdf;Integrated Security = True";
                conn = new SqlConnection(constr);
                conn.Open();
                conn.Close();
            }
